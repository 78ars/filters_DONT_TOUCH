...
<title>страница изменения статьи</title>
<style type="text/css">
...
print <<<HERE
	...
	<label>введите название cтатьи <br>
   ...
   введите описание урока<br>
    <textarea name="description" cols="40" rows="5" maxlength="80" id="description" title="описание">$myrow[description]</textarea><br>
